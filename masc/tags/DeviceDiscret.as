...
package masc.tags {
	...
	public class DeviceDiscret {
		...
		public var R_num:Vector.<int>;
		public var S_num:Vector.<int>;
		public var name:String="Устройство управления аналоговое"; 
		public var srcIN,srcOUT,srcOPEN,srcCLOSE,eu:String;
		
		public function DeviceDiscret() {
			R_num=new Vector.<int>();
			S_num=new Vector.<int>();
		...
		public function dropErr():void{
			errConfig=errOUT_IN=errOUT_R=0;
		}
	}
}
